...
######################################################################################################################
#  Usage :
#       used to transfer GR5405's Keilv5 App Project to iar project which is compiled by iar Compiler
#  Command :
...
class IARPrjGen():
    ...
    def set_ewp_file(self):
        ...
        for str in self.src_list_:
            ...
            str = str.replace("mesh\\lib\\keil\\mesh.lib", "mesh\\lib\\iar\\mesh.a")
            src_list.append(str)
