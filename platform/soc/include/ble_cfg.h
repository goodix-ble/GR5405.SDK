...
#else
#define APP_HEAP_SIZE             (0)
#if ((CFG_GATTS_SUPPORT || CFG_GATTC_SUPPORT) && (CFG_CONTROLLER_ONLY == 0))
#define ATT_DB_HEAP_SIZE          MEM_CALC_HEAP_LEN_IN_BYTES(1024 + APP_HEAP_SIZE)
#else
#define ATT_DB_HEAP_SIZE          MEM_CALC_HEAP_LEN_IN_BYTES(100 + APP_HEAP_SIZE)
#endif
#endif
...
#define REQUIRED_NON_RET_HEAP_SIZE         MEM_CALC_HEAP_LEN_IN_BYTES(328 * 2)
#define NON_RET_HEAP_SIZE                  REQUIRED_NON_RET_HEAP_SIZE
