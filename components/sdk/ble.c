...
extern void ble_common_env_init_for_host(void);
extern void ble_common_env_init_for_both(void);

extern void ble_mul_link_env_init(void);
extern void ble_con_env_init(void);
extern void ble_ccc_sc_oob_pair_env_init(void);
extern void ble_bt_bredr_env_init(void);
extern void ble_test_env_common_init(void);
extern void ble_test_env_v1_init(void);
extern void ble_test_env_v2_init(void);
extern void ble_test_env_v3_init(void);
extern void ble_test_env_v4_init(void);
...
extern void ble_stack_max_connection_number_init(uint8_t cfg_max_connections);
...
void ble_sdk_patch_env_init(void)
{
    ...
    ble_common_env_init_for_host();
    ble_common_env_init_for_controller();
    ble_common_env_init_for_both();
...
static const struct gapm_hci_evt_handler gapm_hci_cmd_cmp_event_handler_tab[] =
{
    ...
    { HCI_RESET_CMD_OPCODE,                            (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },
    { HCI_SET_EVT_MASK_CMD_OPCODE,                     (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },
    { HCI_LE_SET_EVT_MASK_CMD_OPCODE,                  (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },
    { HCI_LE_SET_HOST_CH_CLASS_CMD_OPCODE,             (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },

    { HCI_LE_WR_SUGGTED_DFT_DATA_LEN_CMD_OPCODE,       (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },
    { HCI_LE_WR_RF_PATH_COMP_CMD_OPCODE,               (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },
    { HCI_LE_SET_DFT_PHY_CMD_OPCODE,                   (gapm_hci_evt_hdl_func_t) hci_basic_cmd_cmp_evt_cfg_handler_patch },
...
static const struct ke_msg_handler sdk_msg_handler_tab[] =
{
    ...
    #if (CFG_MAX_ADV || CFG_MAX_SCAN)
    {GAPM_ADV_SCAN_MONITOR_EVT_REPORT_IND,      (ke_msg_func_t)gap_adv_scan_monitor_evt_report_ind_handler },
    #endif
    ...
    {HCI_CMD_CMP_EVENT,                         (ke_msg_func_t)ble_sdk_hci_evt_handler },
    {HCI_CMD_STAT_EVENT,                        (ke_msg_func_t)ble_sdk_hci_evt_handler },
    {HCI_VS_EVENT,                              (ke_msg_func_t)ble_sdk_hci_evt_handler },
...
static void ble_feature_init(void)
{
    ...
    ble_con_env_init();
    ble_stack_max_connection_number_init(CFG_MAX_CONNECTIONS);
    #endif

    #if (DTM_TEST_V1_CMD_ENABLE || DTM_TEST_V2_CMD_ENABLE || DTM_TEST_V3_CMD_ENABLE || DTM_TEST_V4_CMD_ENABLE)
    ble_test_env_common_init();
    #endif

    #if (DTM_TEST_V1_CMD_ENABLE)
    ble_test_env_v1_init();
    #endif

    #if (DTM_TEST_V2_CMD_ENABLE)
    ble_test_env_v2_init();
    #endif

    #if (DTM_TEST_V3_CMD_ENABLE)
    ble_test_env_v3_init();
    #endif

    #if (DTM_TEST_V4_CMD_ENABLE)
    ble_test_env_v4_init();
    #endif

    #if (DTM_TEST_PRIVATE_CMD_ENABLE)
